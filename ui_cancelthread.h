...
public:
    ...
    {
        CancelThread->setWindowTitle(QApplication::translate("CancelThread", "Cancel Operation", Q_NULLPTR));
        pushButton->setText(QApplication::translate("CancelThread", "Cancel Current Operation", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        pushButton->setShortcut(QApplication::translate("CancelThread", "Return", Q_NULLPTR));
