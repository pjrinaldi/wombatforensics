...
wombatforensics: $(OBJECTS) $(SEEKABLE_OBJS)
	g++ -O3 -o wombatforensics $(OBJECTS) $(SEEKABLE_OBJS) -lX11 -lXext -lXft -lfontconfig -lfreetype -lXcursor -lXrender -lXrandr -lXfixes -lXi -lGLU -lGL -ldl -lpthread -ljpeg -lrt -lpng -ltiff -lheif -lz -lbz2 -ltar -lmagic -lzip -lpoppler-cpp -lsnappy -lraptor2 -llz4 -lcrypto -lffmpegthumbnailer libfwsi.a libfwnt.a libhmac.a libewf.a libaff4.a libsmraw.a libvhdi.a libqcow.a libvmdk.a libphdi.a liblexbor_static.a blake3/libblake3.a zstd/libzstd.a libFOX-1.7.a
