...
wombatforensics: $(OBJECTS)
	g++ -O3 -o wombatforensics $(OBJECTS) -lX11 -lXext -lXft -lfontconfig -lfreetype -lXcursor -lXrender -lXrandr -lXfixes -lXi -lGLU -lGL -ldl -lpthread -ljpeg -lrt -lpng -ltiff -lz -lbz2 -ltar -lewf -laff4 -lsmraw -lfwsi -lfwnt -lzstd -lmagic -lzip -lpoppler-cpp -lhubbub -llitehtml blake3/libblake3.a libFOX-1.7.a
