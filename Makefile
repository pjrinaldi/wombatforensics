...
wombatforensics: $(OBJECTS)
	g++ -I/usr/include/ImageMagick-7/ -DMAGICKCORE_HDRI_ENABLE=0 -DMAGICKCORE_QUANTUM_DEPTH=16 -O3 -o wombatforensics $(OBJECTS) -lX11 -lXext -lXft -lfontconfig -lfreetype -lXcursor -lXrender -lXrandr -lXfixes -lXi -lGLU -lGL -ldl -lpthread -ljpeg -lrt -lpng -ltiff -lz -lbz2 -ltar -lzstd -lmagic -lzip -lpoppler-cpp -lsnappy -lraptor2 -llz4 -lcrypto -lffmpegthumbnailer -lMagick++-7.Q16HDRI -lMagickCore-7.Q16HDRI libfwsi.a libfwnt.a libhmac.a libewf.a libaff4.a libsmraw.a liblexbor_static.a blake3/libblake3.a libFOX-1.7.a
