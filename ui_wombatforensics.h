...
public:
    ...
    void setupUi(QMainWindow *WombatForensics)
    {
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/bar/textencode"), QSize(), QIcon::Normal, QIcon::Off);
        actionTextViewer->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/log"), QSize(), QIcon::Normal, QIcon::Off);
        actionViewMessageLog->setIcon(icon13);
        actionExpandAll = new QAction(WombatForensics);
        actionExpandAll->setObjectName(QString::fromUtf8("actionExpandAll"));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/bar/expandall"), QSize(), QIcon::Normal, QIcon::Off);
        actionExpandAll->setIcon(icon14);
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/bar/collapseall"), QSize(), QIcon::Normal, QIcon::Off);
        actionCollapseAll->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/bar/ispade"), QSize(), QIcon::Normal, QIcon::Off);
        actionDigDeeper->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/bar/byteview"), QSize(), QIcon::Normal, QIcon::Off);
        actionByteConverter->setIcon(icon17);
        actionCheck = new QAction(WombatForensics);
        actionCheck->setObjectName(QString::fromUtf8("actionCheck"));
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/echeck"), QSize(), QIcon::Normal, QIcon::Off);
        actionCheck->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/bar/docsave"), QSize(), QIcon::Normal, QIcon::Off);
        actionSaveState->setIcon(icon19);
        actionSettings = new QAction(WombatForensics);
        actionSettings->setObjectName(QString::fromUtf8("actionSettings"));
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/bar/settingsview"), QSize(), QIcon::Normal, QIcon::Off);
        actionSettings->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/bar/managetags"), QSize(), QIcon::Normal, QIcon::Off);
        actionBookmark_Manager->setIcon(icon21);
        actionJumpToHex = new QAction(WombatForensics);
        actionJumpToHex->setObjectName(QString::fromUtf8("actionJumpToHex"));
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/bar/jumptohex"), QSize(), QIcon::Normal, QIcon::Off);
        actionJumpToHex->setIcon(icon22);
        ...
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/bar/reportpreview"), QSize(), QIcon::Normal, QIcon::Off);
        actionpreviewreport->setIcon(icon23);
        actionsearchhex = new QAction(WombatForensics);
        actionsearchhex->setObjectName(QString::fromUtf8("actionsearchhex"));
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/bar/hexsrch"), QSize(), QIcon::Normal, QIcon::Off);
        actionsearchhex->setIcon(icon24);
        actionpublishresults = new QAction(WombatForensics);
        actionpublishresults->setObjectName(QString::fromUtf8("actionpublishresults"));
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/bar/publish"), QSize(), QIcon::Normal, QIcon::Off);
        actionpublishresults->setIcon(icon25);
