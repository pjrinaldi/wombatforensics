...
HexViewer::HexViewer(FXWindow* parent, const FXString& title):FXDialogBox(parent, title, DECOR_TITLE|DECOR_RESIZE|DECOR_BORDER|DECOR_CLOSE, 0, 0, 400, 300, 0,0,0,0, 0, 0)
{
...
/*
void HexViewer::GetText(FXString* buf)
{
    textview->getText(*buf);
}

void HexViewer::GenerateReport(FXArray<FXString> taggedlist, std::vector<std::string> tags)
{
    // PLACE TITLE
