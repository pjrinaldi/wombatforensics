...
/*!
    ...
    \sa minimum, maximum
*/
void QAbstractSliderLong::setRange(int min, int max)
{
    Q_D(QAbstractSliderLong);
...
/*!
    Destroys the slider.
*/
QAbstractSliderLong::~QAbstractSliderLong()
{
}
...
/*!
    ...
    Qt::Horizontal.
*/
void QAbstractSliderLong::setOrientation(Qt::Orientation orientation)
{
    Q_D(QAbstractSliderLong);
...
Qt::Orientation QAbstractSliderLong::orientation() const
{
    Q_D(const QAbstractSliderLong);
...
void QAbstractSliderLong::setMinimum(int min)
{
    Q_D(QAbstractSliderLong);
    setRange(min, qMax(d->maximum, min));
}

int QAbstractSliderLong::minimum() const
{
    Q_D(const QAbstractSliderLong);
    return d->minimum;
}
...
void QAbstractSliderLong::setMaximum(int max)
{
    Q_D(QAbstractSliderLong);
    setRange(qMin(d->minimum, max), max);
}

int QAbstractSliderLong::maximum() const
{
    Q_D(const QAbstractSliderLong);
    return d->maximum;
}
...
void QAbstractSliderLong::setSingleStep(int step)
{
    Q_D(QAbstractSliderLong);
...
int QAbstractSliderLong::singleStep() const
{
    Q_D(const QAbstractSliderLong);
    return d->singleStep;
}
...
void QAbstractSliderLong::setPageStep(int step)
{
    Q_D(QAbstractSliderLong);
    if (step != d->pageStep)
...
int QAbstractSliderLong::pageStep() const
{
    Q_D(const QAbstractSliderLong);
    return d->pageStep;
}
...
/*!
    ...
    \sa sliderDown
*/
void QAbstractSliderLong::setTracking(bool enable)
{
    Q_D(QAbstractSliderLong);
    d->tracking = enable;
}

bool QAbstractSliderLong::hasTracking() const
{
    Q_D(const QAbstractSliderLong);
    return d->tracking;
}
...
*/
void QAbstractSliderLong::setSliderDown(bool down)
{
    Q_D(QAbstractSliderLong);
...
bool QAbstractSliderLong::isSliderDown() const
{
    Q_D(const QAbstractSliderLong);
    return d->pressed;
}
...
*/
void QAbstractSliderLong::setSliderPosition(int position)
{
    Q_D(QAbstractSliderLong);
...
int QAbstractSliderLong::sliderPosition() const
{
    Q_D(const QAbstractSliderLong);
    return d->position;
}
...
int QAbstractSliderLong::value() const
{
    Q_D(const QAbstractSliderLong);
    return d->value;
}

void QAbstractSliderLong::setValue(int value)
{
    Q_D(QAbstractSliderLong);
    value = d->bound(value);
...
bool QAbstractSliderLong::invertedAppearance() const
{
    Q_D(const QAbstractSliderLong);
    return d->invertedAppearance;
}

void QAbstractSliderLong::setInvertedAppearance(bool invert)
{
    Q_D(QAbstractSliderLong);
...
bool QAbstractSliderLong::invertedControls() const
{
    Q_D(const QAbstractSliderLong);
    return d->invertedControls;
}

void QAbstractSliderLong::setInvertedControls(bool invert)
{
    Q_D(QAbstractSliderLong);
...
/*!  Triggers a slider \a action.  Possible actions are \l
  ...
  \sa actionTriggered()
 */
void QAbstractSliderLong::triggerAction(SliderAction action)
{
    Q_D(QAbstractSliderLong);
 ...
 */
void QAbstractSliderLong::setRepeatAction(SliderAction action, int thresholdTime, int repeatTime)
{
    Q_D(QAbstractSliderLong);
...
/*!
  ...
  \sa setRepeatAction()
 */
QAbstractSliderLong::SliderAction QAbstractSliderLong::repeatAction() const
{
    Q_D(const QAbstractSliderLong);
...
/*!\reimp
 */
void QAbstractSliderLong::timerEvent(QTimerEvent *e)
{
    Q_D(QAbstractSliderLong);
...
/*!
    ...
    parameter.
 */
void QAbstractSliderLong::sliderChange(SliderChange)
{
    update();
}
/*
...
*/
#ifndef QT_NO_WHEELEVENT
void QAbstractSliderLong::wheelEvent(QWheelEvent * e)
{
    Q_D(QAbstractSliderLong);
    e->ignore();
    int delta = e->delta();
...
/*!
    \reimp
*/
void QAbstractSliderLong::keyPressEvent(QKeyEvent *ev)
{
    Q_D(QAbstractSliderLong);
...
/*!
    \reimp
*/
void QAbstractSliderLong::changeEvent(QEvent *ev)
{
    Q_D(QAbstractSliderLong);
    switch (ev->type()) {
...
/*!
    \reimp
*/
bool QAbstractSliderLong::event(QEvent *e)
{
#ifdef QT_KEYPAD_NAVIGATION
    Q_D(QAbstractSliderLong);
    switch (e->type()) {
