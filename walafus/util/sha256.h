...
inline void update_w(uint32_t *w, int i, const uint8_t *buffer){
    int j;
    for (j = 0; j < 16; j++){
        if (i < 16){
            w[j] =
...
inline void sha256_block(struct sha256_state *sha){
...
inline void sha256_init(struct sha256_state *sha){
...
inline void sha256_append_byte(struct sha256_state *sha, uint8_t byte){
...
inline void sha256_append(struct sha256_state *sha, const void *src, size_t n_bytes){
...
inline void sha256_finalize(struct sha256_state *sha){
    int i;
...
inline void sha256_finalize_hex(struct sha256_state *sha, char *dst_hex65){
    int i, j;
    sha256_finalize(sha);
...
inline void sha256_finalize_bytes(struct sha256_state *sha, void *dst_bytes32){
