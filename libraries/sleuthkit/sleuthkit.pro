...
SOURCES += sleuthkit.cpp TskDBBlackboard.cpp TskImageFileTsk.cpp TskImgDBSqlite.cpp TskSchedulerQueue.cpp TskSystemPropertiesImpl.cpp TskLog.cpp ../../main/progresswindow.cpp ../../main/wombatvariable.cpp
