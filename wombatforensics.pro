...
SOURCES = main.cpp wombatforensics.cpp wombatdatabase.cpp wombatframework.cpp wombatfunctions.cpp progresswindow.cpp exportdialog.cpp cursor.cpp reader.cpp translate.cpp globals.cpp propertieswindow.cpp wombatproperties.cpp fileviewer.cpp hexviewer.cpp imgreader.cpp imghexviewer.cpp
