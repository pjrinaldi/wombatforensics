...
debug:   DESTDIR = debug
linux:LIBS = -lewf -lvsmbr -lvsgpt -ltsk -ltar -lffmpegthumbnailer -lMagick++-7.Q16HDRI -lMagickCore-7.Q16HDRI -lQtAVWidgets -lQtAV -llnk -lfwnt -lzip -lpoppler-qt5 -lregf -lcrypto -ludev -lafflib -llzo2 -lz -lsquashfuse `pkg-config fuse3 --cflags --libs`
