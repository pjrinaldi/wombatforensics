...
#ifndef QABSTRACTSLIDERLONG_H
#define QABSTRACTSLIDERLONG_H
...
class Q_WIDGETS_EXPORT QAbstractSliderLong : public QWidget
{
    Q_OBJECT
...
public:
    explicit QAbstractSliderLong(QWidget *parent=0);
    ~QAbstractSliderLong();
