 ...
 */
#ifndef WOMBATTSKIMAGEFILETSK_H
#define WOMBATTSKIMAGEFILETSK_H
...
class WombatTskImageFileTsk : public TskImageFile
{
public:
    WombatTskImageFileTsk();

    virtual ~WombatTskImageFileTsk();
