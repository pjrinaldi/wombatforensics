...
/*        }
    ...
    else
    {
        ...
        for(int i=0; i < evidenceidlist.count() / 3; i++)
        {
            ...
            {
                wombatvarptr->evidenceid = evidenceidlist[3*i].toInt();
                wombatvarptr->evidencepath = evidenceidlist[3*i+1];
                wombatvarptr->evidencedbname = evidenceidlist[3*i+2];
            }
        }
