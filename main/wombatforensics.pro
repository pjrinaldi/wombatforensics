...
#VPATH += ../vlc-qt/src/
HEADERS = wombatforensics.h wombatvariable.h wombatdatabase.h ui_wombatforensics.h progresswindow.h ui_progresswindow.h sleuthkit.h TskDBBlackboard.h TskImageFileTsk.h TskImgDBSqlite.h TskLog.h TskSystemPropertiesImpl.h TskSchedulerQueue.h ui_exportdialog.h exportdialog.h hexEditor.hpp box.hpp cursor.hpp delta.hpp grid.hpp offsetConstraint.hpp reader.hpp save.hpp translate.hpp
SOURCES = main.cpp wombatforensics.cpp wombatdatabase.cpp progresswindow.cpp sleuthkit.cpp TskDBBlackboard.cpp TskImageFileTsk.cpp TskImgDBSqlite.cpp TskLog.cpp TskSystemPropertiesImpl.cpp TskSchedulerQueue.cpp exportdialog.cpp hexEditor.cpp cursor.cpp delta.cpp grid.cpp offsetConstraint.cpp reader.cpp save.cpp translate.cpp
