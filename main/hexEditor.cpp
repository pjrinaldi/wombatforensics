...
bool HexEditor::openimage()
{
    ...
    // modify this function to account for a file, possibly by using it's offset???
    // use icat_lib.c for reference..., icat.cpp for reference on how its called and what has to be loaded/found ahead of calling tsk_fs_icat()
    /*
